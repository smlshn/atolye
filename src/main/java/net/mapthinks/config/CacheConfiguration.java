...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(net.mapthinks.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(net.mapthinks.domain.Authority.class.getName(), jcacheConfiguration);
