...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .post("/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "shortName":"SAMPLE_TEXT", "vkn":"SAMPLE_TEXT", "tckn":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "phoneSecond":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "emailSecond":"SAMPLE_TEXT", "webSite":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "addressSecond":"SAMPLE_TEXT", "isCompany":null}""")).asJSON
            .check(status.is(201))
