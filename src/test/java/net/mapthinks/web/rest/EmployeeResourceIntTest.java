...
public class EmployeeResourceIntTest {
    ...
    private static final String DEFAULT_NAME_SURNAME = "AAAAAAAAAA";
    private static final String UPDATED_NAME_SURNAME = "BBBBBBBBBB";
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getNameSurname()).isEqualTo(DEFAULT_NAME_SURNAME);
    ...
    @Test
    @Transactional
    public void checkNameSurnameIsRequired() throws Exception {
        int databaseSizeBeforeTest = employeeRepository.findAll().size();
        // set the field null
        employee.setNameSurname(null);
    ...
    public void updateEmployee() throws Exception {
        ...
        updatedEmployee
            .nameSurname(UPDATED_NAME_SURNAME)
            .title(UPDATED_TITLE)
            .email(UPDATED_EMAIL)
        ...
        Employee testEmployee = employeeList.get(employeeList.size() - 1);
        assertThat(testEmployee.getNameSurname()).isEqualTo(UPDATED_NAME_SURNAME);
