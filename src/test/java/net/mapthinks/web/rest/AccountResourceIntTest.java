...
import net.mapthinks.domain.Authority;
import net.mapthinks.domain.PersistentToken;
import net.mapthinks.domain.User;
import net.mapthinks.repository.AuthorityRepository;
import net.mapthinks.repository.PersistentTokenRepository;
import net.mapthinks.repository.UserRepository;
import net.mapthinks.security.AuthoritiesConstants;
import net.mapthinks.service.MailService;
import net.mapthinks.service.dto.UserDTO;
import net.mapthinks.web.rest.errors.ExceptionTranslator;
import net.mapthinks.web.rest.vm.KeyAndPasswordVM;
import net.mapthinks.web.rest.vm.ManagedUserVM;
